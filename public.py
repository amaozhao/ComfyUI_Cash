...
def get_token():
    techsid = read_json_from_file(
        "techsid" + str(get_port_from_cmdline()) + ".txt", "hash/", "str"
    )
...
def set_token(token):
    write_json_to_file(
        token, "techsid" + str(get_port_from_cmdline()) + ".txt", "hash/"
    )
...
def get_openid():
    openid = read_json_from_file(
        "openid" + str(get_port_from_cmdline()) + ".txt", "hash/", "str"
    )
